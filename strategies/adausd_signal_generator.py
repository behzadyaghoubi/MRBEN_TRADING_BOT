...
class ADAUSDSignalGenerator:
    ...
    def __init__(self, lookback_period=5, price_threshold=0.005):
        ...
        logger.info(
            f"Initialized ADAUSD Signal Generator with lookback={lookback_period}, threshold={price_threshold}"
        )
...
def main():
    ...
    signal_generator = ADAUSDSignalGenerator(
        lookback_period=5, price_threshold=0.003  # Lower threshold for crypto volatility
    )
