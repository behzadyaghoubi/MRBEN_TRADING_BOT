...
class SimplePriceActionSignalGenerator:
    ...
    def __init__(self, lookback_period=5, price_threshold=0.001):
        ...
        logger.info(f"Initialized SimplePriceActionSignalGenerator with lookback={lookback_period}, threshold={price_threshold}")
...
def main():
    ...
    try:
        ...
        try:
            ...
            logger.error("No data file found. Please ensure lstm_signals.csv or lstm_signals_features.csv exists.")
            return
    
    # Initialize signal generator
    signal_generator = SimplePriceActionSignalGenerator(
        lookback_period=5,
        price_threshold=0.0005  # Very low threshold for more signals
    )
