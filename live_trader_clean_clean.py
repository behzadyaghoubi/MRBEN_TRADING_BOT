...
def cmd_live(args):
    ...
    try:
        ...
        try:
            ...
            if core_type == "legacy" or (
                core_type == "modular" and not hasattr(sys.modules[__name__], 'TradingSystem')
            ):
                ...
                if account_info:
                    ...
                    v = max(
                        ...
                        min(
                            ...
                            math.floor(volume / symbol_info.volume_step) * symbol_info.volume_step,
                        ),
                    )
                    return float(Decimal(str(v)).quantize(Decimal(str(symbol_info.volume_step))))
