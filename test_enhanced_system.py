...
def test_adaptive_confidence():
    ...
    try:
        ...
        if (
            good_performance_threshold < initial_threshold
            and poor_performance_threshold > initial_threshold
        ):
