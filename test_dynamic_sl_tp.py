...
from live_trader_clean import MT5LiveTrader, MT5Config, _rolling_atr, _swing_extrema, _linmap
...
class TestDynamicSLTP(unittest.TestCase):
    ...
    def test_dynamic_sl_tp_calculation(self, mock_mt5):
        ...
        sl_price, tp_price, meta = trader._calculate_dynamic_sl_tp(df, entry, signal, confidence, "XAUUSD.PRO")
    ...
    def test_confidence_impact(self, mock_mt5):
        ...
        sl_low, tp_low, meta_low = trader._calculate_dynamic_sl_tp(df, entry, signal, 0.4, "XAUUSD.PRO")
        
        # Test with high confidence
        sl_high, tp_high, meta_high = trader._calculate_dynamic_sl_tp(df, entry, signal, 0.8, "XAUUSD.PRO")
        
        print(f"📊 Low Confidence (0.4):")
