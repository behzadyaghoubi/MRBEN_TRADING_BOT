...
class SignalComponentTester:
    ...
    def __init__(self):
        ...
        self.signal_generator = MT5SignalGenerator(
            self.config, lstm_model=lstm_model, lstm_scaler=lstm_scaler, ml_filter=ml_filter
        )
    ...
    def test_lstm_component(self, df: pd.DataFrame):
        ...
        try:
            ...
            logger.info("📊 LSTM Component Results:")
    ...
    def test_ta_component(self, df: pd.DataFrame):
        ...
        try:
            ...
            logger.info("📊 TA Component Results:")
    ...
    def test_ml_filter_component(self, lstm_signal: dict, ta_signal: dict):
        ...
        try:
            ...
            logger.info("📊 ML Filter Component Results:")
    ...
    def test_simple_combination(self, lstm_signal: dict, ta_signal: dict):
        ...
        try:
            ...
            combined_signal = lstm_signal['signal'] * lstm_weight + ta_signal['signal'] * ta_weight

            combined_confidence = (
                lstm_signal['confidence'] * lstm_weight + ta_signal['confidence'] * ta_weight
            )

            logger.info("📊 Simple Combination Results:")
            ...
            logger.info(
                f"   Threshold check: |{combined_signal:.4f}| >= 0.3 = {abs(combined_signal) >= 0.3}"
            )
    ...
    def test_full_pipeline_step_by_step(self, df: pd.DataFrame):
        ...
        try:
            ...
            logger.info(
                f"   Final: signal={final_signal['signal']}, confidence={final_signal['confidence']:.4f}"
            )
