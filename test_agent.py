...
def test_agent_imports():
    ...
    try:
        ...
        from agent.prompts import RISK_OFFICER_SYSTEM_PROMPT, SUPERVISOR_SYSTEM_PROMPT

        print("✅ Prompts imported successfully")

        from agent.evaluators import RiskOfficerEvaluator, SupervisorEvaluator
...
def test_schema_creation():
    ...
    try:
        from agent.schemas import ReadOnlyToolSchema, ToolPermission, TradingMode, WriteToolSchema
        ...
        read_tool = ReadOnlyToolSchema(
            name="test_tool", description="Test tool", permission=ToolPermission.READ_ONLY
        )
