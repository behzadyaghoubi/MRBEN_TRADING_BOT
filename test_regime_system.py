...
def test_regime_system():
    ...
    try:
        ...
        print("\n1️⃣ Testing imports...")
        from ai.regime import RegimeConfig, RegimeLabel, create_regime_classifier
        from strategies.scorer import AdaptiveConfig, create_adaptive_scorer
        ...
        scorer_config = AdaptiveConfig(
            base_conf=0.60, trend_bonus=0.10, chop_penalty=0.15, high_vol_penalty=0.10
        )
