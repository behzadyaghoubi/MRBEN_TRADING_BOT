...
class ExecutiveReportGenerator:
    ...
    def _create_performance_dashboard(self, metrics: Dict[str, Any]):
        ...
        try:
            ...
            # Win Rate
            ax1.pie([metrics["trading"]["win_rate"], 1 - metrics["trading"]["win_rate"]], 
            ...
            bars = ax2.bar(perf_metrics, perf_values, color=['#2196F3', '#4CAF50', '#FF9800', '#9C27B0'])
    ...
    def _create_automl_chart(self, metrics: Dict[str, Any]):
        ...
        try:
            ...
            # Add value labels
            for bar, value in zip(bars1, ml_values):
                height = bar.get_height()
