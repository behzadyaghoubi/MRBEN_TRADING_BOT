...
def switch_to_english_keyboard():
    ...
    try:
        ...
        try:
            win32api.PostMessage(win32con.HWND_BROADCAST, win32con.WM_INPUTLANGCHANGEREQUEST, 0, 0x0409)
        except:
            pass
...
def run_with_english_keyboard(command: str, timeout: Optional[int] = None):
    """
...
def run_python_script_with_english_keyboard(script_path: str, timeout: Optional[int] = None):
    """
