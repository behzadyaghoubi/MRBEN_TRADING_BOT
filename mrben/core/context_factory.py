...
class ContextFactory:
    ...
    def create_from_bar(self, bar_data: Dict[str, Any]) -> MarketContext:
        ...
        try:
            ...
            logger.bind(evt="CONTEXT").debug("context_created_from_bar",
                                            price=price,
                                            session=session,
                                            regime=regime)
            ...
            logger.bind(evt="CONTEXT").error("context_creation_error",
                                           error=str(e),
                                           bar_data=bar_data)
    ...
    def create_from_tick(self, tick_data: Dict[str, Any]) -> MarketContext:
        ...
        try:
            ...
            logger.bind(evt="CONTEXT").error("tick_context_creation_error",
                                           error=str(e),
                                           tick_data=tick_data)
            # Return default context
            return self._create_default_context()
    ...
    def _get_session(self, timestamp) -> str:
        ...
        try:
            ...
            logger.bind(evt="CONTEXT").warning("session_detection_error",
                                             error=str(e),
                                             timestamp=timestamp)
            return "off"
    ...
    def _get_regime(self, atr_pts: float) -> str:
        ...
        try:
            ...
            logger.bind(evt="CONTEXT").warning("regime_detection_error",
                                             error=str(e),
                                             atr_pts=atr_pts)
            return "UNKNOWN"
