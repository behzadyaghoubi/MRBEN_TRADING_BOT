...
def test_step13():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            print(
                f"✅ High-risk analysis completed - Risk Score: {risky_result.overall_risk_score:.3f}"
            )
            ...
            from core.metricsx import observe_position_adjustment, observe_position_metric
