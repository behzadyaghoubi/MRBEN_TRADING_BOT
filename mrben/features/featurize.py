...
def build_features(df: pd.DataFrame | np.ndarray, lookback: int = 50) -> np.ndarray:
    """
...
def prepare_ml_features(df: pd.DataFrame | np.ndarray, lookback: int = 50) -> np.ndarray:
    """
...
def prepare_lstm_features(df: pd.DataFrame | np.ndarray, lookback: int = 50) -> np.ndarray:
    """
