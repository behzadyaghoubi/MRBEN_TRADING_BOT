...
def test_step12():
    ...
    try:
        ...
        from core.advanced_risk import AdvancedRiskAnalytics, RiskProfile
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            print(
                f"✅ Risk analysis completed - Overall Risk: {risk_profile.overall_risk_score:.3f}"
            )
            ...
            print(
                f"✅ High-risk analysis completed - Risk Score: {risky_profile.overall_risk_score:.3f}"
            )
            ...
            for metric, threshold_info in dynamic_thresholds.items():
                print(
                    f"   {metric}: {threshold_info['current']:.3f} (base: {threshold_info['base']:.3f})"
                )
            ...
            print(
                f"✅ Correlation analysis active - Matrix size: {len(risk_analytics.correlation_matrix)}"
            )
