...
def test_step7():
    ...
    try:
        ...
        from core.order_management import (
            OrderExecutor, OrderRequest, OrderResult, OrderType,
            OrderFillingMode, OrderStatus, MT5Connector,
            OrderFillingOptimizer, SlippageManager
        )
        ...
        normal_mode = filling_optimizer.select_filling_mode(
        ...
        if not mt5_connector.enabled:
            ...
            assert optimal_mode in [OrderFillingMode.IOC, OrderFillingMode.FOK, OrderFillingMode.RETURN]
