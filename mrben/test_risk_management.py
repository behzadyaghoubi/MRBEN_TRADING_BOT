...
def test_spread_gate():
    ...
    try:
        ...
        result3 = gate.evaluate("EURUSD", 1.1000, 1.10025)
...
def test_exposure_gate():
    ...
    try:
        ...
        current_positions = {"EURUSD": {"size": 1.0}, "GBPUSD": {"size": 0.5}}
...
def test_risk_manager():
    ...
    try:
        ...
        print("✅ Trade result recording test passed")
...
def test_position_sizing():
    ...
    try:
        ...
        stop_loss, method = sizer.suggest_stop_loss(
            symbol="EURUSD", entry_price=1.1000, direction=1, atr_value=0.0030, confidence=0.75
        )
...
def test_integration():
    ...
    try:
        ...
        print(
            f"   Risk gates: {len([r for r in gate_responses if r.result.value == 'pass'])} passed"
        )
