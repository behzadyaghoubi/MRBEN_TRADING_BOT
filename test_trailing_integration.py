...
from live_trader_clean import MT5Config, MT5LiveTrader
...
class TestTrailingIntegration(unittest.TestCase):
    ...
    def test_trailing_stop_integration_no_real_orders(self, mock_mt5):
        ...
        signal_data = {'signal': 1, 'confidence': 0.75, 'ensemble_score': 0.8}  # Buy signal
        ...
        with patch('live_trader_clean.is_spread_ok_dynamic') as mock_spread:
            ...
            print("✅ Position ticket verification: PASSED")
            print("   - Expected: 67890 (position ticket)")
            print(f"   - Actual: {trailing_call_args[0]}")
            print("   - Order ID was: 12345 (correctly different)")
    ...
    def test_trailing_stop_position_not_found(self, mock_mt5):
        ...
        # Create mock signal data
        signal_data = {'signal': 1, 'confidence': 0.75, 'ensemble_score': 0.8}
        ...
        with patch('live_trader_clean.is_spread_ok_dynamic') as mock_spread:
            ...
            print("✅ Trailing stop correctly NOT added when position not found")
