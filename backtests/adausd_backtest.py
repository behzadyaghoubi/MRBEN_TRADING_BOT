...
class ADAUSDBacktester:
            ...
            if position != 0:
                ...
                if position == 1:  # Long position
                    if pnl <= -self.stop_loss:  # Stop loss hit
                        ...
                        logger.info(
                            f"LONG Stop Loss: Entry={entry_price:.4f}, Exit={current_price:.4f}, PnL={pnl*100:.2f}%"
                        )
                        position = 0
                        entry_price = 0
                        entry_time = None
                        ...
                        logger.info(
                            f"LONG Take Profit: Entry={entry_price:.4f}, Exit={current_price:.4f}, PnL={pnl*100:.2f}%"
                        )
                        position = 0
                        entry_price = 0
                        entry_time = None
                    ...
                    if pnl <= -self.stop_loss:  # Stop loss hit
                        ...
                        logger.info(
                            f"SHORT Stop Loss: Entry={entry_price:.4f}, Exit={current_price:.4f}, PnL={pnl*100:.2f}%"
                        )
                        position = 0
                        entry_price = 0
                        entry_time = None
                        ...
                        logger.info(
                            f"SHORT Take Profit: Entry={entry_price:.4f}, Exit={current_price:.4f}, PnL={pnl*100:.2f}%"
                        )
                        position = 0
                        entry_price = 0
                        entry_time = None
    ...
    def plot_results(self, df):
        ...
        plt.axhline(
            y=self.initial_capital, color='red', linestyle='--', alpha=0.7, label='Initial Capital'
        )
