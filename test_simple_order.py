...
"""
Simple Order Test
Tests basic order sending without order_check
"""
...
def test_simple_order():
    """Test sending a simple order to MT5."""
    print("🔍 Testing Simple Order Sending")
    print("=" * 60)
    ...
    request = {
        ...
        "deviation": 20,
        "magic": 654321,
        "comment": f"SIMPLE_TEST_{datetime.now().strftime('%Y%m%d_%H%M%S')}",
