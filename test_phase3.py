...
def test_feature_engineering(df):
    ...
    try:
        ...
        feature_cols = [col for col in features_df.columns if col not in ['timestamp', 'open', 'high', 'low', 'close', 'volume']]
...
def test_label_engineering(df, features_df):
    ...
    try:
        ...
        print(f"✅ Label engineering completed")
        ...
        label_cols = [col for col in labels_df.columns if 'signal_' in col or 'return_' in col or 'confidence_' in col]
...
def test_dataset_management(df, features_df, labels_df):
    ...
    try:
        ...
        print(f"✅ Dataset management completed")
...
def main():
    ...
    print(f"✅ Train/Val/Test splits created and saved")
