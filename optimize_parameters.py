...
from advanced_models import build_advanced_lstm, build_enhanced_lstm_classifier
                ...
                for dropout in param_grid['dropout_rate']:
                    for batch_size in param_grid['batch_size']:
                        try:
                            ...
                            self.logger.warning(f"Error with params {lr}, {units}, {dropout}, {batch_size}: {e}")
                            continue
    ...
    try:
        ...
        if 'signal' in data.columns:
            ...
            if len(available_features) >= 4:
                ...
                ml_params, ml_score = optimizer.optimize_ml_filter_parameters(
                    X_train, y_train
                )
                
                # Generate report
                optimizer.generate_optimization_report(
                    lstm_params, lstm_score, ml_params, ml_score
                )
