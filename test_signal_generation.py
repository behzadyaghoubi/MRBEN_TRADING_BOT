...
from live_trader_clean import MRBENAdvancedAISystem, MT5Config
...
def test_signal_generation():
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        # Display results
        print(f"Signal: {signal_data['signal']} ({'BUY' if signal_data['signal'] == 1 else 'SELL' if signal_data['signal'] == -1 else 'HOLD'})")
