...
class TradingEnvironment:
    ...
    def __init__(self, data_path: str = "data/labeled_events.csv", 
    ...
    def _execute_trade(self, signal_data: Dict, tp1_mult: float, tp2_mult: float,
                      sl_mult: float, tp_share: float, size_mult: float) -> Dict:
    ...
    def _simulate_trade_outcome(self, signal_data: Dict, entry: float, 
                               sl: float, tp1: float, tp2: float, tp_share: float) -> Dict:
        ...
        outcome = random.choices(
            ['tp1', 'tp2', 'sl'], 
            weights=[tp1_prob, tp2_prob, sl_prob]
        )[0]
