...
def test_data_files():
    ...
    try:
        ...
        print_status(f"✅ Data files loaded successfully", "SUCCESS")
...
def test_lstm_performance(sequences, labels):
    ...
    try:
        ...
        print_status(f"✅ Performance Results:", "SUCCESS")
        ...
        print_status(f"   Prediction distribution:", "INFO")
        ...
        for i in range(min(5, len(X_test))):
            ...
            print_status(f"   Sample {i+1}: {status} Pred={pred_signal} (Conf={confidence:.3f}), Actual={actual_signal}", "INFO")
...
def test_signal_generation():
    ...
    try:
        ...
        print_status(f"✅ Signal generated:", "SUCCESS")
        print_status(f"   Signal: {signal_data['signal']} ({['SELL', 'HOLD', 'BUY'][signal_data['signal']]})", "INFO")
