...
class ConfigLoader:
    ...
    def load_ai_config() -> Dict[str, Any]:
        ...
        return {
            'model_path': ConfigLoader.get_str('AI_MODEL_PATH', 'models/mrben_ai_signal_filter_xgb.joblib'),
    ...
    def load_logging_config() -> Dict[str, Any]:
        ...
        return {
            ...
            'max_file_size': ConfigLoader.get_int('LOGGING_MAX_FILE_SIZE', 10 * 1024 * 1024),  # 10MB
