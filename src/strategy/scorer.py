...
def adapt_confidence(base_confidence: float, regime: RegimeLabel, config: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        adjustments = regime_adjustments or default_adjustments.get(regime.value, {"conf_mult": 1.0, "thr_add": 0.0})
        ...
        logger.info(f"Confidence adaptation: {base_confidence:.3f} -> {adjusted_confidence:.3f} "
