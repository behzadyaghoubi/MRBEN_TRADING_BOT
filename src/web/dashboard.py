                            ...
                            dbc.Card(
                                [
                                    dbc.CardBody(
                                        [
                                            html.H4(
                                                "Open Positions", className="card-title text-info"
                                            ),
                            ...
                            dbc.Card(
                                [
                                    dbc.CardBody(
                                        [
                                            html.H4(
                                                "Total Trades", className="card-title text-warning"
                                            ),
                            ...
                            dbc.Card(
                                [
                                    dbc.CardBody(
                                        [
                                            html.H4(
                                                "AI Status", className="card-title text-primary"
                                            ),
                                            html.H2(
                                                id="ai-status-display", className="text-primary"
                                            ),
                                            html.P(
                                                id="ai-confidence-display", className="text-muted"
                                            ),
                                        ]
                                    )
                                ]
                ...
                [
                    dbc.Col(
                        [
                            dbc.Card(
                                [
                                    dbc.CardHeader([html.H5("Latest Trades", className="mb-0")]),
                                    dbc.CardBody(
                                        [
                                            dcc.Loading(
                                                [
                                                        ...
                                                        style_data_conditional=[
                                                            {
                                                                "if": {
                                                                    ...
                                                                    "filter_query": "{unrealized_profit} > 0",
                                                                },
                                                                "color": "green",
                                                                "fontWeight": "bold",
                                                            },
...
def register_dashboard_callbacks(app):
    ...
    def save_settings(n_clicks, symbol, timeframe, enabled):
        ...
        if n_clicks:
            try:
                # Update settings
                settings.update_trading_config(symbol=symbol, timeframe=timeframe, enabled=enabled)
    ...
    def update_trades_table(n_intervals, n_clicks):
        ...
        try:
            ...
            trades_df['timestamp'] = pd.to_datetime(trades_df['timestamp']).dt.strftime(
                '%Y-%m-%d %H:%M'
            )
