...
class TradingEngine:
    ...
    def run_single_cycle(self) -> bool:
        ...
        try:
            ...
            if success:
                ...
                self.logger.info(f"Trade executed successfully: {trade_signal.action} {trade_signal.symbol}")
    ...
    def _get_current_price(self, signal_type: str) -> Optional[float]:
    ...
    def _prepare_trade_signal(
        ...
        try:
            ...
            stop_loss = risk_manager.calculate_stop_loss(
                current_price, signal_result.signal, atr
            )
            ...
            lot_size = risk_manager.calc_lot_size(
                balance, stop_loss_pips, pip_value, len(open_positions),
                settings.trading.start_balance, settings.trading.symbol
            )
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'open_positions': len(self.position_manager.get_open_positions(settings.trading.symbol)),
