...
class DatabaseManager:
    ...
    def get_trades(self, limit: Optional[int] = None, status: Optional[str] = None) -> pd.DataFrame:
    ...
    def get_signals(self, limit: Optional[int] = None, executed: Optional[bool] = None) -> pd.DataFrame:
    ...
    def calculate_performance_metrics(self, start_date: Optional[str] = None, end_date: Optional[str] = None) -> Dict[str, Any]:
