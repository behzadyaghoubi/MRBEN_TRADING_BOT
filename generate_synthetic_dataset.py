...
def generate_synthetic_dataset():
    ...
    synthetic_df = generate_synthetic_samples(hold_data, buy_data, sell_data, 
                                            target_hold, target_buy, target_sell)
...
def generate_synthetic_samples(hold_data, buy_data, sell_data, target_hold, target_buy, target_sell):
...
def generate_oversampled_data(data, target_count, signal_type):
    ...
    for _ in range(repeat_times + 1):
        ...
        numeric_columns = ['open', 'high', 'low', 'close', 'SMA20', 'SMA50', 'RSI', 'MACD', 'MACD_signal', 'MACD_hist']
