...
class LSTMSignalBalancer:
    ...
    def __init__(self, 
        ...
        logger.info(f"LSTM Signal Balancer initialized:")
    ...
    def export_signals(self, df: pd.DataFrame, output_path: str, signal_col: str = 'balanced_signal'):
        ...
        export_columns = ['time', 'close', 'lstm_buy_proba', 'lstm_hold_proba', 
                         'lstm_sell_proba', signal_col, 'signal_confidence', 'signal_reason', 'signal_label']
...
def main():
    ...
    print(f"   Output: lstm_balanced_signals_final.csv")
    print(f"   Plot: lstm_balanced_signals_distribution.png")
    print(f"   Test results: threshold_testing_results.csv")
