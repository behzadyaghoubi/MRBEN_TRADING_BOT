...
def check_open_trades():
    ...
    if symbol_positions:
        ...
        print("-" * 80)
        print(
            f"{'Ticket':<10} {'Type':<6} {'Volume':<8} {'Price Open':<12} {'Price Current':<15} {'SL':<10} {'TP':<10} {'Profit':<12} {'Time':<20}"
        )
        print("-" * 80)
        ...
        for pos in symbol_positions:
            ...
            print(
                f"{pos.ticket:<10} {pos_type:<6} {pos.volume:<8.2f} {pos.price_open:<12.2f} {pos.price_current:<15.2f} {pos.sl:<10.2f} {pos.tp:<10.2f} {pos.profit:<12.2f} {open_time.strftime('%H:%M:%S'):<20}"
            )
