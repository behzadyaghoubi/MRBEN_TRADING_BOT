...
def main():
    ...
    try:
        ...
        print_status(f"✅ Data prepared:", "SUCCESS")
    ...
    try:
        ...
        print_status(f"   Model: models/mrben_lstm_real_data.h5", "INFO")
        print_status(f"   Scaler: models/mrben_lstm_real_data_scaler.save", "INFO")
    except Exception as e:
    ...
    print_status(f"   Model saved: models/mrben_lstm_real_data.h5", "INFO")
    print_status(f"   Scaler saved: models/mrben_lstm_real_data_scaler.save", "INFO")
