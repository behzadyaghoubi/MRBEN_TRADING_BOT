...
class Retrainer:
    def __init__(
        self, log_dir="logs/trades", model_path="models/mrben_ai_signal_filter_xgb.joblib"
    ):
    ...
    def retrain_model(self):
        ...
        if n_samples < 2:
            print(
                "⚠️ فقط یک نمونه برای آموزش داریم. مدل با همین یک مورد آموزش داده می‌شود ولی دقت قابل اعتماد نیست."
            )
