...
class QuickFixMRBENSystem:
    ...
    def generate_ensemble_signal(self, market_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            ml_pred = self._get_ml_filter_prediction(df) if 'ml_filter' in self.models else tech_pred
    ...
    def _get_ml_filter_prediction(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        try:
            ...
            feature_names = self.scalers['ml_filter'].feature_names_in_ if hasattr(self.scalers['ml_filter'], 'feature_names_in_') else []
