...
# --- RL Training ---
def train_dqn_from_log(log_path, model_path, scaler_path=None, history_path=None, log_txt_path=None, epochs=20, batch_size=64, epsilon_start=1.0, epsilon_end=0.05, epsilon_decay=0.995):
    ...
    torch.save({'model_state_dict': dqn.state_dict(), 'state_dim': state_dim, 'action_dim': action_dim, 'state_cols': state_cols}, model_path)
...
def load_rl_model(model_path, scaler_path):
    ...
    state_cols = checkpoint.get('state_cols', ['price', 'sl', 'tp', 'buy_proba', 'sell_proba', 'atr', 'rsi', 'macd'])
    return dqn, scaler, state_cols
...
if __name__ == "__main__":
    ...
    train_dqn_from_log(log_path, model_path, scaler_path, history_path, log_txt_path, epochs=30, batch_size=64) 