...
def test_regime_system():
    ...
    try:
        ...
        print("\n1️⃣ Testing imports...")
        from ai.regime import RegimeConfig, create_regime_classifier
        ...
        from ai.features import adx, atr, session_tag

        # Test ATR calculation
        atr_values = atr(
            trend_data['high'].values, trend_data['low'].values, trend_data['close'].values, 14
        )
